...
st.title("Objectbox Vector store DB Demo")
...
def vector_embedding():
    if "vectors" not in st.session_state:
        ...
        st.session_state.final_documents = (
            st.session_state.text_splitter.split_documents(st.session_state.docs[:4])
        )
...
input_prompt = st.text_input(
    "Enter your question about MicroJIT paper from the saved documents"
)
